          ...
          -->
                    ...
                    <div class="product-main">
                        ...
                        <div class="product-grid">
                            ...
                            ?>
                                <div class="showcase" style="z-index: -10;">

                                    <div class="showcase-banner">
                                        

                                        <img src="../img/<?php echo $dong['hinhAnh']?>" alt="Mens Winter Leathers Jackets" width="200" class="product-img default">
                                        <img src="../img/<?php echo $dong['hinhAnh']?>" alt="Mens Winter Leathers Jackets" width="200" class="product-img hover">
