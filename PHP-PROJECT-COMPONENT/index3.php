...
<body>
  ...
  -->
    ...
    -->
            ...
            <?php include '../PHP-PROJECT-COMPONENT/Components/banner.php'?>   
        ...
        -->
                ...
                <div class="sidebar  has-scrollbar" data-mobile-menu>
                    ...
                    <div class="sidebar-category">
                        ...
                        <ul class="sidebar-menu-category-list">
                            ...
                            <?php include'../PHP-PROJECT-COMPONENT/Components/slidebar-menu-category.php'?>
                            <?php include'../PHP-PROJECT-COMPONENT/Components/slidebar-menu-category.php'?>
                            <?php include'../PHP-PROJECT-COMPONENT/Components/slidebar-menu-category.php'?>
                            <?php include'../PHP-PROJECT-COMPONENT/Components/slidebar-menu-category.php'?>
                            <?php include'../PHP-PROJECT-COMPONENT/Components/slidebar-menu-category.php'?>
                    ...
                    <div class="product-showcase">
                        ...
                        <div class="showcase-wrapper">
                            ...
                            <div class="showcase-container">
                                ...
                                <?php include '../PHP-PROJECT-COMPONENT/Components/showcase.php'?>
                                <?php include '../PHP-PROJECT-COMPONENT/Components/showcase.php'?>
                                <?php include '../PHP-PROJECT-COMPONENT/Components/showcase.php'?>
                                <?php include '../PHP-PROJECT-COMPONENT/Components/showcase.php'?>
                                <?php include '../PHP-PROJECT-COMPONENT/Components/showcase.php'?>
          ...
          -->
                    ...
                    <div class="product-minimal">
                        ...
                        <?php include '../PHP-PROJECT-COMPONENT/Components/product-showcase.php'?>
                            ...
                            ?>
                                <div class="showcase">
                                    ...
                                    <div class="showcase-banner">
                                        ...
                                        <img src="../PHP-PROJECT-COMPONENT/img/<?php echo $dong['hinhAnh']?>" alt="Mens Winter Leathers Jackets" width="200" class="product-img default">
                                        <img src="../PHP-PROJECT-COMPONENT/img/<?php echo $dong['hinhAnh']?>" alt="Mens Winter Leathers Jackets" width="200" class="product-img hover">
